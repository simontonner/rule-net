...
class RipperNode(BaseNode):
    ...
    def __init__(
        ...
        # ripper allows for many kwargs. Since we get only small rules in each node it is sufficient
        #
        #
        # we go with the defaults here. however, we want to have control over the
